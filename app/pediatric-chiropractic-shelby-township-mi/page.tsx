          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
              ...
              <div className="h-[400px] rounded-xl overflow-hidden relative shadow-sm">
                <Image
                  src="/images/services/service-pediatric-care.webp"
                  alt="Young child receiving gentle chiropractic care — pediatric chiropractic at Back and Body in Shelby Township, MI"
                  fill
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <ScoliosisIcon className="w-6 h-6" />, title: 'Scoliosis Treatment', desc: 'Early detection and management for adolescent scoliosis.', href: '/scoliosis-treatment-shelby-township-mi' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The foundation of everything we do — for the whole family.', href: '/chiropractic-care-shelby-township-mi' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Wellness Care', desc: 'Ongoing health maintenance for growing bodies.', href: '/wellness-care-shelby-township-mi' },
              ].map((svc) => (
