        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Neck Pain Treatment', desc: 'Neck and shoulder pain often share the same cause.', href: '/neck-pain-treatment-shelby-township-mi' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Release muscle tension that contributes to shoulder pain.', href: '/massage-therapy-shelby-township-mi' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Arm & Leg Pain', desc: 'Nerve compression can cause pain into the arms.', href: '/arm-leg-pain-shelby-township-mi' },
              ].map((svc) => (
