...
const faqItems = [
  { question: "What's included in the $67 new patient special?", answer: "Your first visit includes a consultation with Dr. Brad, a thorough examination, X-rays if clinically necessary, and your first adjustment -- all for $67. Plus a free consultation to discuss your health goals. No hidden fees, no surprise charges." },
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10 lg:gap-[60px] items-start">
            <ScrollReveal className="pt-5">
              ...
              <Link href="/schedule-appointment" className="btn btn--mint">Book Your $67 First Visit &rarr;</Link>
            ...
            <ScrollReveal delay=".15s">
              <div className="bg-white rounded-xl p-8 md:p-10 border-t-4 border-mint shadow-[0_8px_32px_rgba(0,0,0,.10)]">
                <div className="text-center mb-1.5">
                  <span className="text-[38px] font-extrabold text-amber" style={{ fontFamily: 'var(--font-heading)' }}>$67</span>
      ...
      <section className="py-[100px] md:py-[110px] bg-white">
        <div className="container">
          ...
          <ScrollReveal className="text-center">
            ...
            <Link href="/schedule-appointment" className="btn btn--mint">Start Your Transformation -- $67 &rarr;</Link>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mb-10">
            ...
            <ScrollReveal className="md:col-span-2 xl:row-span-2">
              <div className="bg-white rounded-xl p-8 md:p-11 shadow-[var(--shadow)] hover:shadow-[var(--shadow-lg)] hover:-translate-y-1 transition-all duration-300 h-full">
                ...
                <Link href="/chiropractic-care-shelby-township-mi" className="font-semibold text-sm text-mint inline-flex items-center gap-1 hover:text-green-sec hover:gap-2 transition-all" style={{ fontFamily: 'var(--font-heading)' }}>Chiropractic Care &rarr;</Link>
              </div>
            </ScrollReveal>
            {/* Medium cards */}
            <ScrollReveal className="md:col-span-2" delay=".08s">
              <div className="bg-white rounded-xl p-8 shadow-[var(--shadow)] hover:shadow-[var(--shadow-lg)] hover:-translate-y-1 transition-all duration-300">
                ...
                <Link href="/spinal-decompression-shelby-township-mi" className="font-semibold text-sm text-mint inline-flex items-center gap-1" style={{ fontFamily: 'var(--font-heading)' }}>Spinal Decompression &rarr;</Link>
              </div>
            </ScrollReveal>
            <ScrollReveal className="md:col-span-2" delay=".12s">
              <div className="bg-white rounded-xl p-8 shadow-[var(--shadow)] hover:shadow-[var(--shadow-lg)] hover:-translate-y-1 transition-all duration-300">
                ...
                <Link href="/massage-therapy-shelby-township-mi" className="font-semibold text-sm text-mint inline-flex items-center gap-1" style={{ fontFamily: 'var(--font-heading)' }}>Massage Therapy &rarr;</Link>
              </div>
            </ScrollReveal>
            {/* Small cards */}
            {[
      ...
      <section className="py-[110px] md:py-[120px] bg-white" id="process">
        <div className="container">
          <ScrollReveal className="text-center mb-16">
            ...
            <h2 className="text-[34px] md:text-[44px]" style={{ fontFamily: 'var(--font-heading)' }}>
              <span className="font-normal">Your </span><span className="font-extrabold"><span className="text-mint">$67</span> first visit.</span>
            </h2>
          </ScrollReveal>
