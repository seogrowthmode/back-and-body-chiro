...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'It is not a packaged weight loss program with monthly fees. Dr. Brad provides practical guidance on nutrition, movement, and lifestyle changes that support healthy weight management. No shakes, no pills — just honest guidance.',
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Practical, sustainable guidance for healthy weight management — no shakes, no pills, no monthly fees."
        breadcrumbs={[
          { label: 'Home', href: '/' },
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
              ...
              <div className="h-[400px] rounded-xl overflow-hidden relative shadow-sm">
                <Image
                  src="/images/service-weight-loss.webp"
                  alt="Weight loss program at Back and Body in Shelby Township, MI"
                  fill
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <KinesiologyIcon className="w-6 h-6" />, title: 'Nutrition', desc: 'The dietary foundation of healthy weight management.', href: '/nutrition-shelby-township-mi' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Wellness Care', desc: 'Complete wellness support for lasting health.', href: '/wellness-care-shelby-township-mi' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'Spinal health supports metabolic function.', href: '/chiropractic-care-shelby-township-mi' },
              ].map((svc) => (
