            ...
            <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
              ...
              <div className="h-[400px] rounded-xl overflow-hidden relative shadow-sm">
                <Image
                  ...
                  alt="Applied kinesiology treatment table at Back and Body in Shelby Township, MI"
                  fill
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'Precise, gentle adjustments tailored to your specific condition.', href: '/chiropractic-care-shelby-township-mi' },
