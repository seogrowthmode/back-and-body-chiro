...
export default function NutritionPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <KinesiologyIcon className="w-6 h-6" />, title: 'Weight Loss', desc: 'Nutrition is a key component of healthy weight management.', href: '/services/weight-loss' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Wellness Care', desc: 'Combine nutrition with chiropractic for complete wellness.', href: '/services/wellness-care' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'Nutrition supports and enhances chiropractic results.', href: '/services/chiropractic-care' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Ready to fuel your healing?" anchor="$55 to get started." />
    </>
  );
}
