...
export default function WorkInjuryTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Back Pain Treatment', desc: 'Lifting injuries and back strain from work.', href: '/services/back-pain-treatment' },
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Carpal Tunnel Treatment', desc: 'Repetitive strain injuries from work tasks.', href: '/services/carpal-tunnel-treatment' },
                { icon: <DecompressionIcon className="w-6 h-6" />, title: 'Spinal Decompression', desc: 'Disc injuries from heavy lifting at work.', href: '/services/spinal-decompression' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Hurt at work?" anchor="$55 to get treated right." />
    </>
  );
}
