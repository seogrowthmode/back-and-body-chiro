...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Coverage varies by plan. Our office can help you understand your benefits. Either way, at $55 for a new patient visit, you can find out if decompression is right for you without a big financial commitment.',
  },
];
...
export default function SpinalDecompressionPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The foundation — precise adjustments to support decompression results.', href: '/services/chiropractic-care' },
                { icon: <SciaticaIcon className="w-6 h-6" />, title: 'Sciatica Treatment', desc: 'Decompression is often key to resolving sciatica pain.', href: '/services/sciatica-treatment' },
                { icon: <DiscIcon className="w-6 h-6" />, title: 'Disc Injury Treatment', desc: 'Comprehensive care for herniated and bulging discs.', href: '/services/disc-injury-treatment' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Disc pain doesn't have to mean surgery." anchor="$55 to find out." />
    </>
  );
}
