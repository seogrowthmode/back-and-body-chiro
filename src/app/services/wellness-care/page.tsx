...
export default function WellnessCarePage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The foundation of your wellness routine.', href: '/services/chiropractic-care' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Maintenance massage for stress and tension relief.', href: '/services/massage-therapy' },
                { icon: <PediatricIcon className="w-6 h-6" />, title: 'Nutrition', desc: 'Fuel your body right for optimal health.', href: '/services/nutrition' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Feel good and stay that way." anchor="$55 to start." />
    </>
  );
}
