...
export default function BackPainTreatmentPage() {
  return (
    <>
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                ...
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Sciatica Treatment', desc: 'Targeted relief for radiating leg pain starting in the lower back.', href: '/services/sciatica-treatment' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Stop living with back pain." anchor="$55 to start feeling better." />
    </>
  );
}
