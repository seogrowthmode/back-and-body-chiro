...
export default function ScoliosisTreatmentPage() {
  return (
    <>
            ...
            <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
              ...
              <div className="h-[400px] bg-gradient-to-br from-teal-mid to-teal rounded-xl flex items-center justify-center">
                <svg viewBox="0 0 56 56" fill="none" className="w-14 h-14">
                  <path d="M24 8 C20 16, 32 24, 28 32 C24 40, 32 48, 28 48" stroke="#5ED299" strokeWidth="2" opacity=".3" />
                  <path d="M18 20h20M16 36h24" stroke="#5ED299" strokeWidth="1" opacity=".15" />
                </svg>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <PediatricIcon className="w-6 h-6" />, title: 'Pediatric Chiropractic', desc: 'Early intervention for adolescent scoliosis during growth.', href: '/services/pediatric-chiropractic' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Back Pain Treatment', desc: 'Scoliosis-related back pain treated at the source.', href: '/services/back-pain-treatment' },
                { icon: <DecompressionIcon className="w-6 h-6" />, title: 'Wellness Care', desc: 'Ongoing maintenance to manage scoliosis long-term.', href: '/services/wellness-care' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Living with scoliosis?" anchor="$55 for honest answers." />
    </>
  );
}
