...
export default function SciaticaTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <DecompressionIcon className="w-6 h-6" />, title: 'Spinal Decompression', desc: 'Non-surgical disc relief — the ideal complement for sciatica.', href: '/services/spinal-decompression' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Back Pain Treatment', desc: 'Comprehensive care for all types of back pain.', href: '/services/back-pain-treatment' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Disc Injury Treatment', desc: 'Specialized care for herniated and bulging discs.', href: '/services/disc-injury-treatment' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Stop living with sciatica." anchor="$55 to start healing." />
    </>
  );
}
