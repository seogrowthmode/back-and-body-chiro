...
export default function PrenatalChiropracticPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <PediatricIcon className="w-6 h-6" />, title: 'Pediatric Chiropractic', desc: 'Gentle care for your newborn and growing children.', href: '/services/pediatric-chiropractic' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Prenatal massage to relieve pregnancy muscle tension.', href: '/services/massage-therapy' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Back Pain Treatment', desc: 'Comprehensive back pain care for during and after pregnancy.', href: '/services/back-pain-treatment' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Pregnant and in pain?" anchor="$55 for gentle relief." />
    </>
  );
}
