...
export default function MassageTherapyPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The perfect complement to massage — adjustments plus soft tissue work.', href: '/services/chiropractic-care' },
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Neck Pain Treatment', desc: 'Massage is highly effective for cervical muscle tension.', href: '/services/neck-pain-treatment' },
                { icon: <DecompressionIcon className="w-6 h-6" />, title: 'Spinal Decompression', desc: 'Combined with massage for comprehensive disc and muscle relief.', href: '/services/spinal-decompression' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Muscle tension holding you back?" anchor="$55 to get started." />
    </>
  );
}
