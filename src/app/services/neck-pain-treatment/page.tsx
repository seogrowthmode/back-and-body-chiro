...
export default function NeckPainTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <HeadacheIcon className="w-6 h-6" />, title: 'Headaches & Migraines', desc: 'Many headaches originate from cervical dysfunction.', href: '/services/headaches-migraines' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Release muscle tension that compounds neck pain.', href: '/services/massage-therapy' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Whiplash Treatment', desc: 'Specialized care for neck injuries from auto accidents.', href: '/services/whiplash-treatment' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Tired of living with neck pain?" anchor="$55 to start." />
    </>
  );
}
