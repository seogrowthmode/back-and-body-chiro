...
export default function WhiplashTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Neck Pain Treatment', desc: 'Comprehensive neck care for whiplash-related pain.', href: '/services/neck-pain-treatment' },
                { icon: <HeadacheIcon className="w-6 h-6" />, title: 'Headaches & Migraines', desc: 'Post-accident headaches treated at the cervical source.', href: '/services/headaches-migraines' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Soft tissue therapy for whiplash muscle guarding.', href: '/services/massage-therapy' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Been in an accident?" anchor="$55 — don't wait." />
    </>
  );
}
