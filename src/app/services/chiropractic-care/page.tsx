          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                ...
                { icon: <KinesiologyIcon className="w-6 h-6" />, title: 'Applied Kinesiology', desc: 'Advanced muscle testing diagnostics for deeper insight.', href: '/services/applied-kinesiology' },
              ].map((svc) => (
