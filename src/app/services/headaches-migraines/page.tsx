...
export const metadata: Metadata = {
  ...
  description:
    'Headache and migraine treatment from Dr. Brad Krawczyk. Find the cervical cause and fix it — no medication. $55 New Patient Special. (586) 207-1624. Shelby Township, MI.',

  alternates: {
    canonical: "https://backandbodydoc.com/services/headaches-migraines/",
  },
};
...
export default function HeadachesMigrainesPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Neck Pain Treatment', desc: 'Neck dysfunction is the most common cause of chronic headaches.', href: '/services/neck-pain-treatment' },
                { icon: <MassageIcon className="w-6 h-6" />, title: 'Massage Therapy', desc: 'Release the muscle tension that contributes to headaches.', href: '/services/massage-therapy' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The foundation of headache treatment at Back and Body.', href: '/services/chiropractic-care' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Done with headaches running your life?" anchor="$55 to find the cause." />
    </>
  );
}
