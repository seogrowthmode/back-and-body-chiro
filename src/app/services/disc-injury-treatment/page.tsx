...
export default function DiscInjuryTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <DecompressionIcon className="w-6 h-6" />, title: 'Spinal Decompression', desc: 'The ideal complement for disc injuries — gentle traction therapy.', href: '/services/spinal-decompression' },
      ...
      <ConversionCTA line1="Disc injury doesn't have to mean surgery." anchor="$55 to explore your options." />
    </>
  );
}
