...
export default function VertigoTreatmentPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <NeckPainIcon className="w-6 h-6" />, title: 'Neck Pain Treatment', desc: 'Cervical dysfunction is a common vertigo cause.', href: '/services/neck-pain-treatment' },
                { icon: <HeadacheIcon className="w-6 h-6" />, title: 'Headaches & Migraines', desc: 'Vertigo and headaches often share cervical origins.', href: '/services/headaches-migraines' },
                { icon: <SpineIcon className="w-6 h-6" />, title: 'Chiropractic Care', desc: 'The foundation of cervicogenic vertigo treatment.', href: '/services/chiropractic-care' },
              ].map((svc) => (
      ...
      <ConversionCTA line1="Room still spinning?" anchor="$55 to find out why." />
    </>
  );
}
