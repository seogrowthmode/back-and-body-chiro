...
export default function ArmLegPainPage() {
  return (
    <>
            ...
            <div className="grid md:grid-cols-[1.5fr_1fr] gap-12 items-center">
              ...
              <div className="h-[400px] bg-gradient-to-br from-teal-mid to-teal rounded-xl flex items-center justify-center">
                <svg viewBox="0 0 56 56" fill="none" className="w-14 h-14">
                  <path d="M28 8v16" stroke="#5ED299" strokeWidth="1.5" opacity=".25" />
                  <path d="M28 24l-12 16M28 24l12 16" stroke="#5ED299" strokeWidth="1.5" opacity=".2" />
                  <path d="M28 16l-10 4M28 16l10 4" stroke="#5ED299" strokeWidth="1" opacity=".15" />
                </svg>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div className="container">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-6 max-w-[1000px] mx-auto">
              {[
                { icon: <SciaticaIcon className="w-6 h-6" />, title: 'Sciatica Treatment', desc: 'The most common cause of radiating leg pain.', href: '/services/sciatica-treatment' },
      ...
      <ConversionCTA line1="Pain radiating into your arms or legs?" anchor="$55 to trace the source." />
    </>
  );
}
