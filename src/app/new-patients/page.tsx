...
export default function NewPatientsPage() {
  return (
    <>
      <PageHero
        title={<>
          Your <span className="text-mint">$55</span> first visit.
        </>}
      ...
      <section className="py-24 bg-teal relative overflow-hidden" style={{ clipPath: 'polygon(0 0, 100% 40px, 100% 100%, 0 calc(100% - 40px))' }}>
        ...
        <div className="container relative z-10 text-center">
          ...
          <ScrollReveal>
            <div className="mb-8">
              <span className="text-[72px] font-extrabold text-amber leading-none" style={{ fontFamily: 'var(--font-heading)' }}>$55</span>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start max-w-[1100px] mx-auto">
              <div>
                ...
                <div className="prose-custom">
                  ...
                  <p>Don&apos;t have insurance? No problem. Our pricing is straightforward and affordable. The $55 new patient special is available to everyone, regardless of insurance status.</p>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  { title: 'Cash / Self-Pay', desc: 'Competitive rates for those without insurance. $55 new patient special available to everyone.' },
      ...
      <ConversionCTA line1="$55 gets you started." anchor="No nonsense. Just results." />
    </>
  );
}
