...
const reviews = [
  ...
  { tag: 'First Visit', text: 'The $55 first visit was a great deal. Got a thorough exam, X-rays, and my first adjustment all in one visit. No surprise charges. Refreshingly straightforward.' },
...
export default function TestimonialsPage() {
  return (
    <>
      ...
      <ConversionCTA line1="Join 34+ happy patients." anchor="$55 to get started." />
    </>
  );
}
